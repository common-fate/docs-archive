...
2. Download the checksums for the release:
   ...
   ```
   curl -OL releases.commonfate.io/gdeploy/v0.3.2/checksums.txt
   ```

3. Download the signature file:

   ```
   curl -OL releases.commonfate.io/gdeploy/v0.3.2/checksums.txt.sig
   ```
...
4. Verify the integrity of the release artifact:
   ...
   ```
   gdeploy_0.3.2_linux_x86_64.tar.gz: OK
   ```
