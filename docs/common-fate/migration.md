...
In v0.11.0 the platform has been rebranded to be called Common Fate, this includes renaming the repository from common-fate/common-fate to commonfate/common-fate.
