...
:::note
The process below will use `v0.7.0` as the version of `gdeploy`. Ensure that you change references to `v0.7.0` to the version of Granted Approvals you wish to verify when following this process.
:::
