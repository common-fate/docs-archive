...
sso_account_id=v0.0.5[1:]v0.0.5[1:]12
...
More information on using IAM users and roles can be found [here](https://blog.coinbase.com/you-need-more-than-one-aws-account-aws-bastions-and-assume-role-v0.0.5[1:]c6dfde3).
...
region=us-east-1
source_profile=base
role_arn=arn:aws:iam::v0.0.5[1:]v0.0.5[1:]12:role/my-role
```
...
```
curl -OL releases.commonfate.io/granted/vv0.0.5[1:]/granted_vv0.0.5[1:][1:]_linux_x86_64.tar.gz
sudo tar -zxvf ./granted_vv0.0.5[1:][1:]_linux_x86_64.tar.gz -C /usr/local/bin/
```
...
```
curl -OL releases.commonfate.io/granted/vv0.0.5[1:]/granted_vv0.0.5[1:][1:]_linux_arm64.tar.gz
sudo tar -zxvf ./granted_vv0.0.5[1:][1:]_linux_arm64.tar.gz -C /usr/local/bin/
```
...
```
curl -OL releases.commonfate.io/granted/vv0.0.5[1:]/granted_vv0.0.5[1:][1:]_linux_i386.tar.gz
sudo tar -zxvf ./granted_vv0.0.5[1:][1:]_linux_i386.tar.gz -C /usr/local/bin/
```
...
[Granted for Windows x86_64](https://releases.commonfate.io/granted/vv0.0.5[1:]/granted_vv0.0.5[1:][1:]_windows_x86_64.zip)

[Granted for Windows arm64](https://releases.commonfate.io/granted/vv0.0.5[1:]/granted_vv0.0.5[1:][1:]_windows_arm64.zip)

[Granted for Windows i386](https://releases.commonfate.io/granted/vv0.0.5[1:]/granted_vv0.0.5[1:][1:]_windows_i386.zip)
...
You'll need to move Granted to a folder which is accessible on your `PATH`. [This StackOverflow link](https://stackoverflow.com/questions/v0.0.5[1:]80/where-can-i-set-path-to-make-exe-on-windows) has instructions on how to do this.
