...
If you need to revert to an older version of Granted, you can manually downgrade using the following steps. Replace "0.20.1" with the specific version you want to install.

#### For Intel (x86_64 architecture):

```bash
curl -OL https://releases.commonfate.io/granted/v0.20.1/granted_0.20.1_darwin_x86_64.tar.gz
sudo tar -zxvf ./granted_0.20.1_darwin_x86_64.tar.gz -C /usr/local/bin/
...
```bash
curl -OL https://releases.commonfate.io/granted/v0.20.1/granted_0.20.1_darwin_arm64.tar.gz
sudo tar -zxvf ./granted_0.20.1_darwin_arm64.tar.gz -C /usr/local/bin/
ln -s /usr/local/bin/granted /usr/local/bin/assumego
```
...
```
curl -OL releases.commonfate.io/granted/v0.20.1/granted_0.20.1_linux_x86_64.tar.gz
sudo tar -zxvf ./granted_0.20.1_linux_x86_64.tar.gz -C /usr/local/bin/
...
curl -OL releases.commonfate.io/granted/v0.20.1/granted_0.20.1_linux_arm64.tar.gz
sudo tar -zxvf ./granted_0.20.1_linux_arm64.tar.gz -C /usr/local/bin/
...
```
curl -OL releases.commonfate.io/granted/v0.20.1/granted_0.20.1_linux_i386.tar.gz
sudo tar -zxvf ./granted_0.20.1_linux_i386.tar.gz -C /usr/local/bin/
...
[Granted for Windows x86_64](https://releases.commonfate.io/granted/v0.20.1/granted_0.20.1_windows_x86_64.zip)

[Granted for Windows arm64](https://releases.commonfate.io/granted/v0.20.1/granted_0.20.1_windows_arm64.zip)

[Granted for Windows i386](https://releases.commonfate.io/granted/v0.20.1/granted_0.20.1_windows_i386.zip)
