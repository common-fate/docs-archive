...
sudo tar -zxvf ./granted_0.5.1_linux_x86_64.tar.gz -C /usr/local/bin/
...
curl -OL releases.commonfate.io/granted/v0.5.1/granted_0.5.1_linux_arm64.tar.gz
sudo tar -zxvf ./granted_0.5.1_linux_arm64.tar.gz -C /usr/local/bin/
...
```
curl -OL releases.commonfate.io/granted/v0.5.1/granted_0.5.1_linux_i386.tar.gz
sudo tar -zxvf ./granted_0.5.1_linux_i386.tar.gz -C /usr/local/bin/
...
[Granted for Windows x86_64](https://releases.commonfate.io/granted/v0.5.1/granted_0.5.1_windows_x86_64.zip)

[Granted for Windows arm64](https://releases.commonfate.io/granted/v0.5.1/granted_0.5.1_windows_arm64.zip)

[Granted for Windows i386](https://releases.commonfate.io/granted/v0.5.1/granted_0.5.1_windows_i386.zip)
