...
As part of [Granted v0.9.0](https://github.com/common-fate/granted/releases/tag/v0.9.0), the Profile Registry didn't require the `-n` or `-u` flags. [Granted v0.9.0](https://github.com/common-fate/granted/releases/tag/v0.9.0) includes breaking changes to this. If you are using a version of Profile Registries prior to Granted v0.9.0, run the following command to migrate your registry configuration:
