...
:::info
`cf` version above 0.5.1 has all the PDK related commands inside the `cf oss` subcommand.
:::
...
```
curl -OL releases.commonfate.io/cf/v0.5.1/cf_0.5.1_darwin_x86_64.tar.gz
sudo tar -zxvf ./cf_0.5.1_darwin_x86_64.tar.gz -C /usr/local/bin/
```
...
```
curl -OL releases.commonfate.io/cf/v0.5.1/cf_0.5.1_darwin_arm64.tar.gz
sudo tar -zxvf ./cf_0.5.1_darwin_arm64.tar.gz -C /usr/local/bin/
```
...
```
curl -OL releases.commonfate.io/cf/v0.5.1/cf_0.5.1_linux_x86_64.tar.gz
sudo tar -zxvf ./cf_0.5.1_linux_x86_64.tar.gz -C /usr/local/bin/
```
...
```
curl -OL releases.commonfate.io/cf/v0.5.1/cf_0.5.1_linux_arm64.tar.gz
sudo tar -zxvf ./cf_0.5.1_linux_arm64.tar.gz -C /usr/local/bin/
```
...
```
curl -OL releases.commonfate.io/cf/v0.5.1/cf_0.5.1_linux_i386.tar.gz
sudo tar -zxvf ./cf_0.5.1_linux_i386.tar.gz -C /usr/local/bin/
```
...
[cf for Windows x86_64](https://releases.commonfate.io/cf/v0.5.1/cf_0.5.1_windows_x86_64.zip)

[cf for Windows arm64](https://releases.commonfate.io/cf/v0.5.1/cf_0.5.1_windows_arm64.zip)

[cf for Windows i386](https://releases.commonfate.io/cf/v0.5.1/cf_0.5.1_windows_i386.zip)
